...
* @version 1.0
* @date    20-7-2023
* @brief   Generate a PWM signal with a frequency of 50hz and a duty cycle of 50% using Timer0.
 ...
 * The measured result is which is displayed on serial monitor of arduino (there is a percentage of error due to context switch of the interrupts):
	High time (microseconds): 10193.69
	Low time (microseconds): 10193.69
	Cycle time (microseconds): 20387.38
	Duty cycle (%): 50.00
	Frequency (Hz): 49.05
 ...
 * High time (microseconds): 10000
 * Low time (microseconds): 10000
 * Cycle time (microseconds): 20000
 * Duty cycle (%): 50%
 * Frequency (Hz): 50hz
 */
